# Task: Fix little issues to launch Tsunami AquaPark site

## Plan Steps (Approved)
1. [x] Create TODO.md for tracking
2. [x] Edit index.html: Add missing alt attributes to images
3. [x] Edit index.html: Fix footer copyright year from 2026 to 2024
